...
Using the Alpha, Beta, Live iterate approach we've decided to start small, and iterate as necessary. Following this approach, we would be able to build a lab that would pay for itself from the savings of costs avoided.
